...
It is important to set a random seed beore using a function that uses randomness (e.g. shuffling data, sampling, or simulations). This allows you to get the exact same sequence of random numbers each time and makes your code testable.
